/*
  ...
  - You are about to drop the column `firstname` on the `jobapplication` table. All the data in the column will be lost.
  - You are about to drop the column `lastname` on the `jobapplication` table. All the data in the column will be lost.
...
*/
-- AlterTable
ALTER TABLE `jobapplication` DROP COLUMN `firstname`,
